    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(unique=True, max_length=300)),
                ('description', models.TextField()),
                ('collection', models.ForeignKey(to='core.QRCollection', on_delete=django.db.models.deletion.PROTECT)),
            ],
        ),
        migrations.AddField(
            model_name='completedtags',
            name='tag',
            field=models.ForeignKey(to='core.QRTag'),
        ),
        migrations.AddField(
            model_name='completedtags',
            name='user',
